				...
				if (players.get(counter) != null) {
					...
					for(String s : instance.testerUsers) {
						if(s.equals(player.username)) {
							...
							player.cloakUrl = (player.playerCloakUrl = "https://dl.dropbox.com/u/22865035/ModHosting/capes/tester-cape.png");
						}
					}
					...
					for(String s : instance.donorUsers) {
						if(s.equals(player.username)) {
							...
							// set the cloak url of the player
							player.cloakUrl = (player.playerCloakUrl = "https://dl.dropbox.com/u/22865035/ModHosting/capes/donor-cape.png");
						}
					}
